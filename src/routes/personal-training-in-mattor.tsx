...
export const Route = createFileRoute("/personal-training-in-mattor")({
  head: () => ({
    meta: [
      { title: "Personal Training in Mattor | Family Fitness Centre" },
      { name: "description", content: "Personal training in Mattor with certified coaches. 1-on-1 sessions, custom workout plans, nutrition guidance and accountability at Family Fitness Centre, Kerala." },
      { property: "og:title", content: "Personal Training in Mattor | Family Fitness Centre" },
      { property: "og:description", content: "Get results faster with 1-on-1 personal training in Mattor. Custom plans, expert coaches, real accountability." },
...
function PTPage() {
  return (
    <LocalServicePage
      eyebrow="Personal Training in Mattor"
      title={<>Expert <span className="text-gradient-primary">Personal Training</span> in Mattor</>}
      intro="One-on-one coaching designed around your body, goals and schedule — right here in Mattor, Kerala."
      image={ptImg}
      imageAlt="Personal training session in Mattor at Family Fitness Centre"
      highlights={[
        ...
        { title: "Flexible Scheduling", text: "Morning, evening and weekend slots across Mattor." },
      ]}
      relatedLinks={[
      ...
      body={
        <>
          <p>
            Our <strong>personal training in Mattor</strong> is built on three principles —
